...
class ExpendituresControllerTest < ActionController::TestCase
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post :create, expenditure: { cost: @expenditure.cost, date_of_purchase: @expenditure.date_of_purchase, item: @expenditure.item }
    end
  ...
  test "should update expenditure" do
    patch :update, id: @expenditure, expenditure: { cost: @expenditure.cost, date_of_purchase: @expenditure.date_of_purchase, item: @expenditure.item }
    assert_redirected_to expenditure_path(assigns(:expenditure))
  end
